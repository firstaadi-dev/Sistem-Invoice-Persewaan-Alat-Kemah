...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="order.php">TA SBD</a>
    ...
    <div class="container">
      <ul class="list-unstyled list-inline text-center py-2">
        <li class="list-inline-item">
          <h2 class="mb-1">Tugas Akhir Praktikum SBD</h2>
        </li>
      </ul>
    </div>
    <div class="footer-copyright text-center py-3">2020 Copyright: Firsta Adi Pradana</div>
  </footer>
